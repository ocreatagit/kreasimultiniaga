        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?php echo base_url() ?>index.php/backend/delete_project/<?php echo $project->IDProjek ?>" onclick="return confirm('Anda yakin akan menghapus data ini ?')" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
