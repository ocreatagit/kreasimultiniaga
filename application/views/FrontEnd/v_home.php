...
<html lang="en">
    ...
    <body>
         Navigation 
        <nav class="navbar navbar navbar-fixed-top" style="background-color: #F1592A;" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-collapse" rel="home" href="#" title="">
                          <img style="" src="img/1.png">
                    </a>
                    <a class="navbar-brand" href="#" style="margin-top: 7%;">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="#" style="">OUR PROJECTS</a>
                        </li>
                        <li>
                            <a href="#" style="">CONTACT US</a>
                        </li>
                    </ul>
                </div>
                 /.navbar-collapse 
        ...
        <div style="background-color: whitesmoke; margin: 0%; margin-top: -2%;"></div>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
             ...
             Collect the nav links, forms, and other content for toggling 
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="background-color: #FFCC99;">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="#">About</a>
                    </li>
